...
public class ShortestPathFinder {
    ...
    private static String path = "";
                                          ...
                                          int[] parents)
        {
            ...
            path = "";
            return Integer.toString(distances[nVertices-1])+" "+ printPath(nVertices-1, parents);
        ...
        public static String findShortestPath(int[][] adjacencyMatrix){

            String res =dijkstra(adjacencyMatrix, 0);
            Log.d("dijek",res);
            return res;
